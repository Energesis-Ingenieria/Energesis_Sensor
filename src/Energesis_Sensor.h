...
#define ENERGESIS_PATCH_VERSION 2
...
namespace Energesis
{
  ...
  public:
     ...
     *
     */
    Energesis_OnOffSensor(bool _inverted_logic = false, std::function<void(bool)> *_callback = NULL) : m_invert_logic(m_invert_logic), m_callback(_callback) {}
